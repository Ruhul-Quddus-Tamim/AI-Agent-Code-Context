"""
Sandbox Tools - File system operations for local execution
                ...
                with open(filepath, "r", encoding="utf-8", errors="ignore") as f:
                    for line_num, line in enumerate(f, 1):
                        ...
                        if fuzzy_threshold is not None:
                            if fuzz is None:
                                raise ToolError("rapidfuzz library is required for fuzzy search. Install it with: pip install rapidfuzz")
